...
## Getting Started
### System Requirements
| Plugin Version | Supported Snap Version(s) | Supported [Mesos][mesos-home] Version(s) | Supported InfluxDB Publisher Version(s) |
|----------------|---------------------------|------------------------------------------|-----------------------------------------|
| v1             | v0.14-beta                | 0.26.x, 0.27.x, 0.28.x                   | v13+                                    |
| v2             | v0.18                     | 1.0.x                                    | v15+                                    |
